"""
Django settings for img_study_buddy project.
...
SECRET_KEY = 'django-insecure-0yh2dg2f6hmoug$w_pqyxv_w@^-7vpr^)5yb+b$t&@(gn!i_i9'
...
ROOT_URLCONF = 'img_study_buddy.urls'
...
WSGI_APPLICATION = 'img_study_buddy.wsgi.application'
...
KEYS = [GENERAL_INFO,CANDIDATE_INFO,EDUCATION_INFO,WORK_EXPERIENCE_INFO,MOTIVATION_INFO,COACH_INFO]
